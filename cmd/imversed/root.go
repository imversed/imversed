...
func (a appCreator) appExport(
	...
	var ethermintApp *app.ImversedApp
	...
	if height != -1 {
		ethermintApp = app.NewImversedApp(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := ethermintApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		ethermintApp = app.NewImversedApp(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
