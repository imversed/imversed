...
| --- | --- | --- | --- | --- |
| [`web3_clientVersion`](https://docs.imversed.com/developers/json-rpc/endpoints.html#web3-clientversion) | Web3 |  ✔  |  ✔  | --- |
| [`web3_sha3`](https://docs.imversed.com/developers/json-rpc/endpoints.html#web3-sha3) | Web3 |  ✔  |  ✔  | --- |
| [`net_version`](https://docs.imversed.com/developers/json-rpc/endpoints.html#net-version) | Net |  ✔  |  ✔  | --- |
| [`net_peerCount`](https://docs.imversed.com/developers/json-rpc/endpoints.html#net-peerCount) | Net |  ✔  |  ✔  | --- |
| [`net_listening`](https://docs.imversed.com/developers/json-rpc/endpoints.html#net-listening) | Net |  ✔  |  ✔  | --- |	
| [`eth_protocolVersion`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-protocolversion) | Eth |  ✔  |  ✔  | --- |
| [`eth_syncing`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-syncing) | Eth |  ✔  |  ✔  | --- |
| [`eth_gasPrice`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-gasprice) | Eth |  ✔  |  ✔  | --- |
| [`eth_accounts`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-accounts) | Eth |  ✔  |  ✔  | --- |
| [`eth_blockNumber`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-blocknumber) | Eth |  ✔  |  ✔  | --- |
| [`eth_getBalance`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getbalance) | Eth |  ✔  |  ✔  | --- |
| [`eth_getStorageAt`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getstorageat) | Eth |  ✔  |  ✔  | --- |
| [`eth_getTransactionCount`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-gettransactioncount) | Eth |  ✔  |  ✔  | --- |
| [`eth_getBlockTransactionCountByNumber`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getblocktransactioncountbynumber) | Eth |  ✔  |  ✔  | --- |
| [`eth_getBlockTransactionCountByHash`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getblocktransactioncountbyhash) | Eth |  ✔  |  ✔  | --- |
| [`eth_getCode`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getcode) | Eth |  ✔  |  ✔  | --- |
| [`eth_sign`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sign) | Eth |  ✔  |  ✔  | --- |
| [`eth_sendTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sendtransaction) | Eth |  ✔  |  ✔  | --- |
| [`eth_sendRawTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sendrawtransaction) | Eth |  ✔  |  ✔  | --- |
| [`eth_call`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-call) | Eth |  ✔  |  ✔  | --- |
| [`eth_estimateGas`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-estimategas) | Eth |  ✔  |  ✔  | --- |
| [`eth_getBlockByNumber`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getblockbynumber) | Eth |  ✔  |  ✔  | --- |
| [`eth_getBlockByHash`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getblockbyhash) | Eth |  ✔  |  ✔  | --- |
| [`eth_getTransactionByHash`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-gettransactionbyhash) | Eth |  ✔  |  ✔  | --- |
| [`eth_getTransactionByBlockHashAndIndex`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-gettransactionbyblockhashandindex) | Eth |  ✔  |  ✔  | --- |
| [`eth_getTransactionReceipt`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-gettransactionreceipt) | Eth |  ✔  |  ✔  | --- |
| [`eth_newFilter`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-newfilter) | Eth |  ✔  |  ✔  | --- |
| [`eth_newBlockFilter`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-newblockfilter) | Eth |  ✔  |  ✔  | --- |
| [`eth_newPendingTransactionFilter`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-newpendingtransactionfilter) | Eth |  ✔  |  ✔  | --- |
| [`eth_uninstallFilter`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-uninstallfilter) | Eth |  ✔  |  ✔  | --- |
| [`eth_getFilterChanges`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getfilterchanges) | Eth |  ✔  |  ✔  | --- |
| [`eth_getFilterLogs`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getfilterlogs) | Eth |  ✔  |  ✔  | --- |
| [`eth_getLogs`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getlogs) | Eth |  ✔  |  ✔  | --- |
...
| `eth_mining` | Eth | --- | ❌ | --- |
| [`eth_coinbase`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-coinbase) | Eth |  ✔  | --- | --- |
...
| [`eth_getProof`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-getProof) | Eth |  ✔  |    | --- |
| [`eth_subscribe`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-subscribe) | Websocket |  ✔  | --- | --- |
| [`eth_unsubscribe`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-unsubscribe) | Websocket |  ✔  | --- | --- |
| [`personal_importRawKey`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-importrawkey) | Personal | ✔ | ❌ | --- |
| [`personal_listAccounts`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-listaccounts) | Personal | ✔ | ❌ | --- |
| [`personal_lockAccount`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-lockaccount) | Personal | ✔ | ❌ | --- |
| [`personal_newAccount`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-newaccount) | Personal | ✔ | ❌ | --- |
| [`personal_unlockAccount`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-unlockaccount) | Personal | ✔ | ❌ | --- |
| [`personal_sendTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-sendtransaction) | Personal | ✔ | ❌ | --- |
| [`personal_sign`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-sign) | Personal | ✔ | ❌ | --- |
| [`personal_ecRecover`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-ecrecover) | Personal | ✔ | ❌ | --- |
| [`personal_initializeWallet`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal_initializewallet) | Personal | ✔ | ❌ | --- |
| [`personal_unpair`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal_unpair) | Personal | ✔ | ❌ | --- |
| `db_putString` | DB | --- | --- | --- |
| `db_getString` | DB | --- | --- | --- |
| `db_putHex` | DB | --- | --- | --- |
| `db_getHex` | DB | --- | --- | --- |
...
| [`debug_traceBlock`](https://docs.imversed.com/developers/json-rpc/endpoints.html#debug-traceblock) | Debug | ✔ | --- | --- |
| [`debug_traceBlockByNumber`](https://docs.imversed.com/developers/json-rpc/endpoints.html#debug-traceblockbynumber) | Debug | ✔ | --- | --- |
| [`debug_traceBlockByHash`](https://docs.imversed.com/developers/json-rpc/endpoints.html#debug-traceblockbyhash) | Debug | ✔ | --- | --- |
| `debug_traceBlockFromFile` | Debug | --- | --- | --- |
| `debug_standardTraceBlockToFile` | Debug | --- | --- | --- |
| `debug_standardTraceBadBlockToFile` | Debug | --- | --- | --- |
| [`debug_traceTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#debug-tracetransaction) | Debug |  ✔  | --- | --- |
...
| [`miner_getHashrate`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-gethashrate) | Miner |  ✔  | ❌ | No-op |
| [`miner_setExtra`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-setextra) | Miner |  ✔  | ❌ | No-op |
| [`miner_setGasPrice`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-setgasprice) | Miner |  ✔  | ❌ | Needs node restart |
| [`miner_start`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-start) | Miner |  ✔  | ❌ | No-op |
| [`miner_stop`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-stop) | Miner |  ✔  | ❌ | No-op |
| [`miner_setGasLimit`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-setgaslimit) | Miner |  ✔  | ❌ | No-op |
| [`miner_setEtherbase`](https://docs.imversed.com/developers/json-rpc/endpoints.html#miner-setetherbase) | Miner |  ✔  | ❌ |   |
| [`txpool_content`](https://docs.imversed.com/developers/json-rpc/endpoints.html#txpool-content) | TxPool |  ✔  |   |   |
| [`txpool_inspect`](https://docs.imversed.com/developers/json-rpc/endpoints.html#txpool-inspect) | TxPool |  ✔  |   |   |
| [`txpool_status`](https://docs.imversed.com/developers/json-rpc/endpoints.html#txpool-status) | TxPool |  ✔  |   |   |
...
```text
 {"jsonrpc":"2.0","id":1,"result":"Imversed/0.1.3+/linux/go1.18"}
```
...
* Object containing:
  ...
  `to`: `DATA`, 20 Bytes - (optional when creating new contract) The address the transaction is directed to.`gas`: QUANTITY - (optional, default: 90000) Integer of the gas provided for the transaction execution. It will return unused gas.
...
Creates new message call transaction or a contract creation for signed transactions. You can get signed transaction data using the [`personal_sign`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-sign) method.
...
Read about websockets in [events](https://docs.imversed.com/developers/json-rpc/events.html).
...
The account can be used with [`eth_sign`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sign) and [`eth_sendTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sendtransaction) while it is unlocked.
...
The transaction is the same argument as for [`eth_sendTransaction`](https://docs.imversed.com/developers/json-rpc/endpoints.html#eth-sendtransaction) and contains the `from` address. If the passphrase can be used to decrypt the private key belonging to `tx.from` the transaction is verified, signed and send onto the network.
...
**Parameters**
* Message
* Signature returned from [`personal_sign`](https://docs.imversed.com/developers/json-rpc/endpoints.html#personal-sign)
...
Make sure your `imversed start` call is not using the flag `minimum-gas-prices` because this value will be used instead of the one set on the configuration file.
