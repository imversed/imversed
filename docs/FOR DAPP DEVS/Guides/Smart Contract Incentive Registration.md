...
In addition, gRPC queries related to the `x/incentives` module found [here](https://docs.imversed.com/x/incentives/spec/08_clients.html#clients) can produce useful analysis.
