  ...
  <div class="content-wrapper">
    <div class="flex w-full items-center">
      ...
      <div class="footer-links">
        <p>
          <a href="mailto:support@imversed.com" target="_blank" rel="noopener">
        ...
        <p>
          <a href="https://imversed.com" target="_blank" rel="noopener">
            <span class="right-footer-icon">
              <Reply />
            </span>
            back to imversed.com
          </a>
        </p>
...
export default {
  ...
  methods: {
    ...
    getIssueUrl() {
      return encodeURI(
        `mailto:support@imversed.com?subject=Improve “${this.$page.title}”&body=I have a suggestion for https://docs.imversed.com${this.$route.fullPath}:\n`
      );
    },
  },
  watch: {
