...
sed -i -e 's/"community_tax": "0.020000000000000000"/"community_tax": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&
sed -i -e 's/ "base_proposer_reward": "0.010000000000000000"/ "base_proposer_reward": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&
sed -i -e 's/"bonus_proposer_reward": "0.040000000000000000"/"bonus_proposer_reward": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&

sed -i -e 's/"inflation_rate_change": "0.130000000000000000"/"inflation_rate_change": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&
sed -i -e 's/"inflation_max": "0.200000000000000000"/"inflation_max": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&
sed -i -e 's/"inflation_min": "0.070000000000000000"/"inflation_min": "0.000000000000000000"/g' ~/.imversed/config/genesis.json &&
sed -i -e 's/"goal_bonded": "0.670000000000000000"/"goal_bonded": "0.000000000000000001"/g' ~/.imversed/config/genesis.json &&
