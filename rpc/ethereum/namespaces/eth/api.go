...
func NewPublicAPI(
	...
	eip155ChainID, err := imversed.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
...
func (e *PublicAPI) ProtocolVersion() hexutil.Uint {
	...
	return hexutil.Uint(imversed.ProtocolVersion)
}
...
func (e *PublicAPI) Resend(ctx context.Context, args evmtypes.TransactionArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, tx := range pending {
		// FIXME does Resend api possible at all?  https://github.com/imversed/imversed/issues/905
