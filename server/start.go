...
import (
	...
	ethdebug "github.com/imversed/imversed/rpc/ethereum/namespaces/debug"
...
`,
	...
	cmd.Flags().Uint64(srvflags.JSONRPCGasCap, config.DefaultGasCap, "Sets a cap on gas that can be used in eth_call/estimateGas unit is nimv (0=infinite)")
	cmd.Flags().Float64(srvflags.JSONRPCTxFeeCap, config.DefaultTxFeeCap, "Sets a cap on transaction fee that can be sent via the RPC APIs (1 = default 1 imv)")
