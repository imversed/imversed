...
var (
	_ = sample.AccAddress
	_ = currencysimulation.FindAccount
...
func (am AppModule) RandomizedParams(_ *rand.Rand) []simtypes.ParamChange {
	currencyParams := types.DefaultParams()
	return []simtypes.ParamChange{
		simulation.NewSimParamChange(types.ModuleName, string(types.KeyTxMintCurrencyCost), func(r *rand.Rand) string {
			return string(types.Amino.MustMarshalJSON(currencyParams.TxMintCurrencyCost))
		}),
	}
}
