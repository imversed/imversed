...
For an overview on  the JSON-RPC methods and namespaces supported on Ethermint, please refer to [https://docs.imversed.zone/basics/json_rpc.html](https://docs.imversed.zone/basics/json_rpc.html)
