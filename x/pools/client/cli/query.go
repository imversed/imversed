...
func GetQueryCmd() *cobra.Command {
	// Group pools queries under a subcommand
	cmd := &cobra.Command{
...
Example:
$ %s query pools spot-price 1 stake stake2
`,
				version.AppName,
			),
		),
...
Example:
$ %s query pools estimate-swap-exact-amount-in 1 osm11vmx8jtggpd9u7qr0t8vxclycz85u925sazglr7 stake --swap-route-pool-ids=2 --swap-route-amounts=100stake2 --swap-route-pool-ids=3 --swap-route-amounts=100stake
`,
				version.AppName,
			),
		),
...
Example:
$ %s query pools estimate-swap-exact-amount-out 1 osm11vmx8jtggpd9u7qr0t8vxclycz85u925sazglr7 stake --swap-route-pool-ids=2 --swap-route-amounts=100stake2 --swap-route-pool-ids=3 --swap-route-amounts=100stake
`,
				version.AppName,
			),
		),
